...
export const SAVE_INTIAL_NOTIFICATION = 'SAVE_INTIAL_NOTIFICATION';
...
export const START_OUTBOX_SENDING = 'START_OUTBOX_SENDING';
export const FINISHED_OUTBOX_SENDING = 'FINISHED_OUTBOX_SENDING';
...
export const WEBVIEW_CLEAR_MESSAGES_FROM = 'WEBVIEW_CLEAR_MESSAGES_FROM';
export const WEBVIEW_CLEAR_ALL_UPDATE_MESSAGES = 'WEBVIEW_CLEAR_ALL_UPDATE_MESSAGES';
export const WEBVIEW_CLEAR_ALL_UPDATE_MESSAGE_TAGS = 'WEBVIEW_CLEAR_ALL_UPDATE_MESSAGE_TAGS';
