...
var getStartAndEndNodes = function getStartAndEndNodes() {
  ...
  var startMsgId = getMessageIdFromNode(startNode, Number.MAX_SAFE_INTEGER);
  var endMsgId = getMessageIdFromNode(endNode, 0);
  ...
  var messagesNodes = document.getElementsByClassName('message');
  ...
  var firstMsgNode = messagesNodes[0];
  var lastMsgNode = messagesNodes[messagesNodes.length - 1];
