...
export const EVENT_QUEUE_REGISTERED = 'EVENT_QUEUE_REGISTERED';
export const EVENT_QUEUE_SUSPENDED = 'EVENT_QUEUE_SUSPENDED';
export const EVENT_QUEUE_RESTARTED = 'EVENT_QUEUE_RESTARTED';
