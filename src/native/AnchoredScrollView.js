 ...
 *
 * @providesModule AnchoredScrollView
 * @flow
 */
'use strict';
...
const ScrollView = React.createClass({
  ...
  render: function() {
    ...
    let ScrollViewClass;
    if (Platform.OS === 'ios') {
      ScrollViewClass = AnchoredScrollView;
...
let nativeOnlyProps, AndroidScrollView, AndroidHorizontalScrollView, AnchoredScrollView;
if (Platform.OS === 'android') {
  nativeOnlyProps = {
    nativeOnly: {
  ...
  AnchoredScrollView = requireNativeComponent('AnchoredScrollView', ScrollView, nativeOnlyProps);
}
